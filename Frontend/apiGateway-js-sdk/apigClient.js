...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://iyg33vq8hl.execute-api.us-east-1.amazonaws.com/beta';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'Accept', 'Accept-Control-Allow-Headers', 'Content-Type', 'x-amz-meta-customLabels', 'Accept-Control-Allow-Origin', 'Accept-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketKeyPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Accept', 'Accept-Control-Allow-Headers', 'Content-Type', 'x-amz-meta-customLabels', 'Accept-Control-Allow-Origin', 'Accept-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
